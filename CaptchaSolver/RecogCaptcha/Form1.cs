...
namespace RecogCaptcha
{
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                if (actual != null)
                    resultado.Text = CaptchaSolver.OCR(actual);
                else
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                InsertarCambio("ColorFiltering");
                anterior = MethodsImagenFilter.CopyBitmap(actual);
                actual = MethodsImagenFilter.ColorFiltering(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                InsertarCambio("SetPixelColor");
                anterior = MethodsImagenFilter.CopyBitmap(actual);
                actual = MethodsImagenFilter.SetPixelColor(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            try
            {
                InsertarCambio("Scaled");
                anterior = MethodsImagenFilter.CopyBitmap(actual);
                actual = MethodsImagenFilter.Scaled(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
