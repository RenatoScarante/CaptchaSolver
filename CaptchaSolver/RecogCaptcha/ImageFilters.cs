...
namespace RecogCaptcha
{
    public class MethodsImagenFilter
    {
        ...
        public static Bitmap ColorFiltering(Bitmap Imagem)
        {
            ColorFiltering filter = new ColorFiltering();
            filter.Blue = new AForge.IntRange(200, 255);
            filter.Red = new AForge.IntRange(200, 255);
            filter.Green = new AForge.IntRange(200, 255);
